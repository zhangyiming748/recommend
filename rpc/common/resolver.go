...
func ConsulResolver(address string, serviceName string) (schema string, err error) {
	tars := strings.Split(address, ",")
	builder := NewConsulBuilder(tars[rand.Intn(len(tars))])
