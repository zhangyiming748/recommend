...
var lens = []int{SHOWLISTLEN, CLICKLISTLEN, QUICKSHOWLISTLEN}

func getUserPersonalInfo(user string) (pinfo PersonalInfo) {
	...
	go func() {
		...
		Infoln("getUserPersonalinfo ", user, " usertaglen:", len(history_usertag), ".")
		Infoln("getUserPersonalinfo ", user, " usertaglen:", history_usertag, ".")
